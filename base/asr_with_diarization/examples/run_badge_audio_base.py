...
from openmmla.bases.asr_with_diarization import BadgeAudioBase
...
def run_audio_base(args):
    badge_audio_base = BadgeAudioBase(project_dir=args.project_dir, config_path=args.config_path, mode=args.mode,
                                      vad=args.vad, nr=args.nr, tr=args.tr, sp=args.sp, store=args.store)
