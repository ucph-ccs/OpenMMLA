...
from openmmla.bases.indoor_positioning import VideoVisualizer
...
def run_visualizer(args):
    visualizer = VideoVisualizer(project_dir=args.project_dir, config_path=args.config_path, store=args.store)
    visualizer.run()
