...
def generate_end_to_end_prompt_msg(id_positions, image_data, action_definitions):
    ...
    user_text = (
        ...
        "- **Face Direction**: Describe which direction the person's face/head is physically turned toward (e.g., facing forward, turned toward left side of room, profile view facing right). If face is not visible or direction is ambiguous, state \"face direction not clearly visible\".\n"
        ...
        "      \"face_direction\": \"Face turned slightly downward, oriented toward visible laptop screen on desk\",\n"
        ...
        "      \"face_direction\": \"Face direction not clearly visible due to distance from camera and lighting conditions\",\n"
        ...
        "      \"face_direction\": \"Face oriented directly toward visible computer monitor in front of them\",\n"
        ...
        "    \"43\": \"Classified as 'Unclear' because face direction is not clearly visible and no specific activity is observable\",\n"
        "    \"Untagged Person 1\": \"Classified as 'Observing' because they are clearly facing a computer monitor without evidence of typing or software manipulation, suggesting they are viewing content\"\n"
        "  }\n"
        "}\n"
        "```"
    )
...
def generate_vlm_prompt_msg(id_positions=None, image_input=None):
    ...
    system_content = (
        ...
        "If something is not clearly visible (like a person's face direction or what they're holding), explicitly "
    ...
    user_text = (
        ...
        "- When in doubt, note uncertainty rather than guessing\n\n"
        "### Response Format\n"
        "Return your observations as a JSON object with the following structure (the IDs below are just EXAMPLES, "
        "use the actual IDs from the detected list and \"Untagged Person X\" for others):\n\n"
        "```json\n"
        "{\n"
        "  \"observations\": {\n"
        "    \"12\": {\n"
        "      \"position\": \"Center-right of the frame, approximately at coordinates (0.7, 0.5)\",\n"
        "      \"posture\": \"Seated at desk with back slightly hunched forward, upper body fully visible with shoulders relaxed\",\n"
        "      \"face_direction\": \"Face oriented downward toward visible laptop screen positioned on desk\",\n"
        ...
        "      \"position\": \"Bottom-right corner of frame, partially visible\",\n"
        "      \"posture\": \"Seated at what appears to be a desk or table, only upper torso visible in frame\",\n"
        "      \"face_direction\": \"Head turned toward visible computer monitor directly in front of them\",\n"
        "      \"hands_objects\": \"Hands visible and resting in lap, interlaced with fingers clasped together. No objects being held\",\n"
        "      \"interactions\": \"No interaction with other individuals visible\",\n"
        "      \"clothing\": \"Wearing a red and white patterned shirt, possibly plaid or checkered\"\n"
        "    }\n"
...
def generate_llm_prompt_msg(image_description, action_definitions):
    ...
    user_text = (
        ...
        "### Response Format\n"
        "Return a JSON object with ID-to-action mappings and justifications based strictly on the provided description "
        "(Below are just EXAMPLES, use the actual IDs and actions from the observation and action categories):\n"
        "```json\n"
        "{\n"
        "  \"classifications\": {\n"
        "    \"12\": \"Working-Software\",\n"
        ...
        "  },\n"
        "  \"justifications\": {\n"
        "    \"12\": \"Classified as 'Working-Software' because description explicitly states they are typing on keyboard while facing a computer screen\",\n"
        "    \"43\": \"Classified as 'Unclear' because description states their face direction is not clearly visible and hands are partially visible\",\n"
        "    \"Untagged Person 1\": \"Classified as 'Observing' because description states their face is oriented toward a visible screen without interacting with it\"\n"
        "  }\n"
        "}\n"
        "```"
    )
