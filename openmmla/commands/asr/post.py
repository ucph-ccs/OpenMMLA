...
def get_parser():
    ...
    add_arg('custom_origin_dir', str, None,
            'path to the custom origin directory, default to <project_dir>/post-time/origin/ when not specified',
            shortname='-custom')
    add_arg('filenames', str, None,
            'comma-separated list of filenames in <custom_origin_dir> to process, default to all files when not specified',
            shortname='-f')
