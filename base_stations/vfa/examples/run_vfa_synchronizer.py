"""This script runs the VFASynchronizer of the video frame analyzer."""
import argparse
import functools
import os
...
def run_vfa_synchronizer(args):
    vfa_synchronizer = VFASynchronizer(project_dir=args.project_dir, config_path=args.config_path)
...
if __name__ == '__main__':
    ...
    run_vfa_synchronizer(input_args) 