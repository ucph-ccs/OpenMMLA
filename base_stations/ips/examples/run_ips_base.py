"""This script runs the IPSBase of the real-time indoor positioning system."""
import argparse
import functools
import os
...
def run_ips_base(args):
    ips_base = IPSBase(project_dir=args.project_dir, config_path=args.config_path, graphics=args.graphics,
