...
from openmmla.bases.asr import start_asr_post_analyzer
...
def main():
    ...
    # Call the centralized start_asr_post_analyzer function with restart capability
    start_asr_post_analyzer(
