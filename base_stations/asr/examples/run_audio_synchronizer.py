...
def run_audio_synchronizer(args):
    synchronizer = AudioSynchronizer(project_dir=project_dir, config_path=args.config_path, base_type=args.base_type,
...
if __name__ == "__main__":
    ...
    run_audio_synchronizer(input_args)
